...
// Occupancy: if we polled it but got NO reply within this window -> not responding.
...
static void Main_CheckDeviceOfflineStatus( double now_ );         ///< Log offline/not-responding devices.
