...
/// @brief  Aqara Occupancy Sensor (Occupancy Sensing 0x0406) module: registry + thread.
///
...
extern AQARA_OCCUPANCY_T g_aqaraOccupancies[MAX_AQARA_OCCUPANCY]; ///< Occupancy registry.
extern int g_numAqaraOccupancies;   ///< Valid entries in @ref g_aqaraOccupancies.

/// @brief  Initialize the Aqara occupancy registry and inbox. Call once at startup.
/// @return None.
...
/// @return Number of zones with presence (0..g_numAqaraOccupancies). Thread-safe.
///
...
/// @brief  Re-enumerate endpoints of all known occupancy sensors (CLI 'discover').
/// @return None.
